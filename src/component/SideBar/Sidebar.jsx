...
function Sidebar() {
  ...
  return (
    <div
      className={`w-60 h-full bg-background fixed z-20 border-r border-gray-600 top-0 transition-transform duration-300 pt-2 ${
    ...
    >
      <div className="p-4">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <button className="text-gray-300 hover:text-white" onClick={() => setSidebarOpen(false)}>Go back</button>
          </li>
        </ul>
      </div>
    </div>
