...
function Sidebar() {
  ...
  return (
    <>  
          <div className={`w-60 h-full bg-background z-20 fixed border-r border-g ray-600 top-0 transition-transform duration-300 pt-2 ${ isVisible ? "translate-x-0" : "-translate-x-full"}`}
          >
            <div className="p-4">
